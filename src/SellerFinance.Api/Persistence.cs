...
public sealed class SellerFinanceDbContext(DbContextOptions<SellerFinanceDbContext> options) : IdentityDbContext<AppUser>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ProductEntity>().HasAlternateKey(x=>new{x.Id,x.OrganizationId});
        ...
        modelBuilder.Entity<OrderEntity>().HasAlternateKey(x=>new{x.Id,x.OrganizationId});
        ...
        modelBuilder.Entity<OrderEntity>().HasOne<MarketplaceConnectionEntity>().WithMany().HasForeignKey(x=>new{x.MarketplaceConnectionId,x.OrganizationId}).HasPrincipalKey(x=>new{x.Id,x.OrganizationId}).OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<OrderStatusHistoryEntity>().HasOne<OrderEntity>().WithMany().HasForeignKey(x=>new{x.OrderId,x.OrganizationId}).HasPrincipalKey(x=>new{x.Id,x.OrganizationId}).OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<MarketplaceConnectionEntity>().HasAlternateKey(x=>new{x.Id,x.OrganizationId});
        ...
        modelBuilder.Entity<SyncJobEntity>().HasOne<MarketplaceConnectionEntity>().WithMany().HasForeignKey(x=>new{x.MarketplaceConnectionId,x.OrganizationId}).HasPrincipalKey(x=>new{x.Id,x.OrganizationId}).OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<ProductCostHistoryEntity>().HasOne<ProductEntity>().WithMany().HasForeignKey(x=>new{x.ProductId,x.OrganizationId}).HasPrincipalKey(x=>new{x.Id,x.OrganizationId}).OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<CostImportRowEntity>().HasOne<CostImportJobEntity>().WithMany().HasForeignKey(x=>x.ImportJobId).OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<FeeRuleEntity>().HasOne<ProductEntity>().WithMany().HasForeignKey(x=>new{x.ProductId,x.OrganizationId}).HasPrincipalKey(x=>new{x.Id,x.OrganizationId}).OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<ExpenseEntity>().HasOne<ProductEntity>().WithMany().HasForeignKey(x=>new{x.ProductId,x.OrganizationId}).HasPrincipalKey(x=>new{x.Id,x.OrganizationId}).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<ExpenseEntity>().HasOne<OrderEntity>().WithMany().HasForeignKey(x=>new{x.OrderId,x.OrganizationId}).HasPrincipalKey(x=>new{x.Id,x.OrganizationId}).OnDelete(DeleteBehavior.Restrict);
